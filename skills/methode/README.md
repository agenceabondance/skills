...
- **[ajouter-source](./ajouter-source/SKILL.md)** : verser une page, une étude ou un brevet dans un corpus, avec son niveau de preuve. Porte le gabarit de fiche source.
...
- **[brevet-google](./brevet-google/SKILL.md)** : lire un brevet Google sur ses revendications, chercher les brevets d'un sujet, rédiger la fiche. Porte `brevet.py` et le gabarit de fiche brevet.
